    ...
    public class Driver {
        ...
        public static void main(String[] args) throws ClassNotFoundException, IOException, InterruptedException {
            ...
            DBConfiguration.configureDB(conf2,
                    ...
                    "jdbc:mysql://ip_address:port/test",  //test is db name
                    "root",
                    "password");
            ...
            //diff between MapOutput, set OutputKey?  Type Text is MapOutput
            //mapper, reducer   -  look at arguments they take
            job2.addArchiveToClassPath(new Path("path_to_ur_connector"));
            job2.setMapOutputKeyClass(Text.class);
            job2.setMapOutputValueClass(Text.class);
            job2.setOutputKeyClass(DBOutputWritable.class);
            job2.setOutputValueClass(NullWritable.class);   //add dependency to class to use, see AutoCompleteNGram.iml
